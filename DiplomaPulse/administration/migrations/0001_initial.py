    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Внутрішня назва, її бачать лише адміністратори', max_length=255)),
                ('public_name', models.CharField(default='Назва завдання', help_text='Назва, яку бачать користувачі', max_length=255)),
                ('description', models.TextField(help_text='Опис завдання, який бачать користувачі')),
